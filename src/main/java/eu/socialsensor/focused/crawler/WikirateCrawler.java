...
public class WikirateCrawler {
	
	private static Logger logger = Logger.getLogger(WikirateCrawler.class);
	...
	public static void main(String[] args) throws UnknownHostException {
		...
		try {
			if(args.length == 1)
				...
				config = new XMLConfiguration("./conf/wikirate.crawler.xml");
		}
        ...
        // Run topology
        String name = config.getString("topology.focusedCrawlerName", "WikirateCrawler");
